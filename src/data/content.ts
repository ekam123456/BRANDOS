export const lifecycle = [
  ["01", "Understand", "Build a living picture of how your business works."],
  ["02", "Diagnose", "Spot friction, opportunity, change and uncertainty."],
  ["03", "Prioritize", "Focus attention on the few moves that matter most."],
  ["04", "Recommend", "Explain what to do, why it matters, and what supports it."],
  ["05", "Execute", "Turn a decision into prepared, approved, traceable work."],
  ["06", "Measure", "See what changed after an action was taken."],
...
export const faqs = [
  ...
  ["Is this an AI chatbot?", "No. Conversation can be an interface, but the product is designed as a controlled system of context, recommendations, workflows and agents—not an ungoverned chat window."],
  ["Does it replace my team?", "It is designed to give people better context and remove repetitive work. Decisions, accountability and the boundaries of execution remain with your business."],
